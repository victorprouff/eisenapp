const translations = {
  fr: {
    ...
    // Modale feedback
    btn_feedback_title: 'Signaler un bug ou suggérer une amélioration',
    feedback_title: 'Signaler un bug ou suggérer',
    feedback_type_label: 'Type',
    feedback_type_bug: 'Bug',
    feedback_type_feature: 'Nouvelle fonctionnalité',
    feedback_type_question: 'Question',
    feedback_title_label: 'Titre',
    feedback_title_placeholder: 'Résumé de votre demande',
    feedback_desc_label: 'Description',
    feedback_desc_placeholder: 'Décrivez votre problème ou suggestion…',
    feedback_email_label: 'Email',
    feedback_optional: '(optionnel)',
    feedback_error: 'Erreur lors de l\'envoi. Réessayez.',
    feedback_sent_title: 'Message envoyé !',
    feedback_sent_body: 'Merci pour votre retour.',
    feedback_track_link: 'Suivre vos demandes sur GitHub →',
    ...
    filter_pro: 'Pro',
    filter_perso: 'Perso',
    filter_hide_completed: 'Masquer terminées',
    flag_pro: 'Pro',
    flag_perso: 'Perso',
  ...
  en: {
    ...
    // Modale feedback
    btn_feedback_title: 'Report a bug or suggest an improvement',
    feedback_title: 'Report a bug or suggest',
    feedback_type_label: 'Type',
    feedback_type_bug: 'Bug',
    feedback_type_feature: 'New feature',
    feedback_type_question: 'Question',
    feedback_title_label: 'Title',
    feedback_title_placeholder: 'Summary of your request',
    feedback_desc_label: 'Description',
    feedback_desc_placeholder: 'Describe your issue or suggestion…',
    feedback_email_label: 'Email',
    feedback_optional: '(optional)',
    feedback_error: 'Error sending. Please try again.',
    feedback_sent_title: 'Message sent!',
    feedback_sent_body: 'Thank you for your feedback.',
    feedback_track_link: 'Track your requests on GitHub →',
  ...
  es: {
    ...
    // Modale feedback
    btn_feedback_title: 'Reportar un error o sugerir una mejora',
    feedback_title: 'Reportar un error o sugerir',
    feedback_type_label: 'Tipo',
    feedback_type_bug: 'Bug',
    feedback_type_feature: 'Nueva funcionalidad',
    feedback_type_question: 'Pregunta',
    feedback_title_label: 'Título',
    feedback_title_placeholder: 'Resumen de tu solicitud',
    feedback_desc_label: 'Descripción',
    feedback_desc_placeholder: 'Describe tu problema o sugerencia…',
    feedback_email_label: 'Email',
    feedback_optional: '(opcional)',
    feedback_error: 'Error al enviar. Inténtalo de nuevo.',
    feedback_sent_title: '¡Mensaje enviado!',
    feedback_sent_body: 'Gracias por tu comentario.',
    feedback_track_link: 'Seguir tus solicitudes en GitHub →',
  ...
  de: {
    ...
    // Modale feedback
    btn_feedback_title: 'Fehler melden oder Verbesserung vorschlagen',
    feedback_title: 'Fehler melden oder vorschlagen',
    feedback_type_label: 'Typ',
    feedback_type_bug: 'Bug',
    feedback_type_feature: 'Neue Funktion',
    feedback_type_question: 'Frage',
    feedback_title_label: 'Titel',
    feedback_title_placeholder: 'Zusammenfassung Ihrer Anfrage',
    feedback_desc_label: 'Beschreibung',
    feedback_desc_placeholder: 'Beschreiben Sie Ihr Problem oder Ihren Vorschlag…',
    feedback_email_label: 'E-Mail',
    feedback_optional: '(optional)',
    feedback_error: 'Fehler beim Senden. Bitte erneut versuchen.',
    feedback_sent_title: 'Nachricht gesendet!',
    feedback_sent_body: 'Vielen Dank für Ihr Feedback.',
    feedback_track_link: 'Anfragen auf GitHub verfolgen →',
    ...
    filter_pro: 'Pro',
    filter_perso: 'Privat',
    filter_hide_completed: 'Erledigte ausblenden',
    flag_pro: 'Pro',
    flag_perso: 'Privat',
